...
const App = () => {
  ...
  const API_KEY = "ed64bd14127ece88fbdf31c47f4faa67";
  ...
  // Fetchs 5 Locations Suggestions from api and updates
  ...
  // This functions prevents form submtion validates city and fetchs data api
  ...
  // This function is check weather and return an object
  const getWeatherCondition = () =>
    weather && {
      min: weather.weather[0].main,
      isDay:
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="flex items-center justify-center p-6 min-h-screen">
        <div
          className="bg-transparent backdrop-filter backdrop-blur-md rounded-xl
          ...
          {!weather ? (
            <form onSubmit={handleSearch} className="flex flex-col relative">
              <input
                ...
                className="mb-4 p-3 rounded border border-white bg-transparent
                  text-white placeholder-white focus:outline
                ...
                <div className="absolute top-12 left-0 right-0 bg-transparent shadow-md rounded z-10">
                  {suggestion.map((s) => (
                    <button
                      ...
                      className="block hover:bg-blue-700 bg-transparent
                        px-4 py-2 text-sm text-left w-full transition-colors"
                    >
                      {s.name}
                      {s.country}
                      {s.state && `,${s.state}`}
              ...
              <button
                type="submit"
                className="bg-purple-700 hover:bg-blue-700
            ...
            <div className="mt-6 text-center transition-opacity duration-500">
              <button
                ...
                className="mb-4 bg-purple-900 hover:bg-blue-700
                  text-white font-semibold py-1 px-3 rounded transition-colors"
              >
                New Search
              </button>
              ...
              <div className="flex flex-wrap justify-around mt-6">
                {[
                  ...
                  [
                    VisibilityIcon,
                    "Visibility",
                    getHumidityValue(weather.visibility),
                  ],
